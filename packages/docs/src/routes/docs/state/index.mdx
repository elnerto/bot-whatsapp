...
De igual manera que el `state` anterior nosotros podemos usar `globalState` para tener un estado general de la app (NO es por usuario), esto es muy util si quieres ejemplo apagar o prender el bot
